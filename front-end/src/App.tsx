...
import {
  ...
  Trees, MapPin, Radio, ChartLine, SlidersHorizontal,
} from 'lucide-react';
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px 32px' }}>
          ...
          <header className="anim-up" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ position: 'relative', width: 8, height: 8, borderRadius: '50%', background: conectado ? '#1d9e75' : '#a32d2d', display: 'inline-block' }}>
                {conectado && (
